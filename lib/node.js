...
var WS_SECRET = process.env.WS_SECRET || "moac-net-stats-has-a-secret";
...
function Node ()
{
	...
	this.startChain3Connection();

	return this;
}

Node.prototype.startChain3Connection = function()
{
	...
	chain3 = new Chain3();
	chain3.setProvider(new chain3.providers.HttpProvider(url));

	this.checkChain3Connection();
}

Node.prototype.checkChain3Connection = function()
{
	var self = this;
	...
	if (!this._chain3) {
		if(chain3.isConnected()) {
			...
			console.error('Trying again in', chalk.cyan(CONNECTION_ATTEMPTS_TIMEOUT + ' ms'));

			setTimeout(function () {
				self.checkChain3Connection();
			}, CONNECTION_ATTEMPTS_TIMEOUT );
		}
	}
}

Node.prototype.reconnectChain3 = function()
{
